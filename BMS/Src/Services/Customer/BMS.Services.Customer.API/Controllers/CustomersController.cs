...
using BMS.Services.Customer.API.Models;

namespace BMS.Services.Customer.API.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CustomersController : ControllerBase
    {
        private readonly BMSCustomerContext _context;

        public CustomersController(BMSCustomerContext context)
        {
            _context = context;
        }

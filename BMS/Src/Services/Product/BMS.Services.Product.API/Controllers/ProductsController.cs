...
using BMS.Services.Product.API.Models;

namespace BMS.Services.Product.API.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ProductsController : ControllerBase
    {
        private readonly BMSProductContext _context;

        public ProductsController(BMSProductContext context)
        {
            _context = context;
        }
